...
- [ ] **Unified Caching Layer**: Migrate `shoppingcart` localStorage implementations to the new `CacheManager` for consistent TTL, memory/session/local storage support, and SSR safety.
